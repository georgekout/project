...
public class Delete {
    public static void deleteEl(List<List<Object>> outerList) {
        ...
        if (whatToDelete == 1) {
            System.out.print("\n Give the name of the column that you want to delete:");
            ...
            System.out.printf("\n From 0-%d which line you want to delete? ", outerList.size()-1);
            ...
            System.out.print("\n Please insert the name of the column that contains the element you want to delete:");
            Scanner col = new Scanner(System.in);
            Object column = col.next();
            int columnFound = Change.searchColumn(outerList,column);

            if (columnFound != -1){
                System.out.print("\n Please insert the element you want to delete:");
                ...
                if(searchEl != -1){
                    ...
                    System.out.print("\n The element you inserted does not exist in the database or in the column " +

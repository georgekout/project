...
public class Output {
    ...
    public static void printDatabase(List<List<Object>> outerList) {
        System.out.print("\n Press 1, in order to see all the elements that the database contains. \n Press 2, in order to see a specific line.  \n " +
        ...
        if (whatToShow == 1) {
            ...
            System.out.println("Please insert an element of the line you would like to be shown: ");
            Scanner answer1 = new Scanner(System.in);
            Object linEl = answer1.next();
            System.out.println("Please insert the column that contains that element: ");
            ...
            if(found != -1){
				...
				if(foundLine != -1){
					...
					System.out.println("The element you inserted does not exist in the database.");
				}
			} else {
				System.out.println("The column you inserted does not exist in the database.");
			}

        } else if (whatToShow == 3) {
            System.out.print("\n Please insert the name of the column you would like to see:");
            ...
            if (columnFound != -1){
				for(int i = 0; i < outerList.size(); i++){
           	 	...
           	 	System.out.print("\n The column you inserted does not exist in the database.");
            }
        }else {
